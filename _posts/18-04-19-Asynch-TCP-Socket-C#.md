...
modify_date: 2018-04-19 15:00:00 +01:00
...
Another important aspect is the amount of data being sent over the stream. There should'nt be any limit of package size.<!--more-->
...
## Final Code
Enough talking. Here are the complete codeblocks for each client- and serverside. I implemented a little bit more code than above in the tutorial, but everything should be well explained in the comments.  
